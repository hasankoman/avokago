  ...
  return (
    <div className="min-h-screen bg-[#F9F9F4] p-6">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <motion.div
            className="w-24 h-24 bg-gradient-to-tr from-[#568203] to-[#A7C957] rounded-3xl flex items-center justify-center mx-auto mb-6"
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          <h1 className="text-3xl font-bold text-[#6B4F1D] mb-4">Ayarlar</h1>
          <p className="text-[#6B4F1D]/70 mb-8">
            Hesap ayarlarınızı ve tercihlerinizi buradan düzenleyin.
          </p>
