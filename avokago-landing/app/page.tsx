              ...
              >
                ...
                <div className="text-center space-y-6">
                  ...
                  <p className="text-[#6B4F1D]/70 leading-relaxed">
                    ...
                    de anlayan seyahat motoru. avokaGo AI, cevapladığın
                ...
                {["Ruh Arayan", "Maceraperest", "Sosyalleşen", "Romantik"].map(
                  (profile, index) => (
                    <motion.button
                      ...
                      className={`px-6 py-3 rounded-xl font-semibold transition-all duration-300 flex-1 relative z-10 ${
                        activeTab === index
                          ? "text-white"
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="font-bold text-xl">avokaGo</span>
              </div>
          ...
          <div className="border-t border-[#357A38]/30 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-[#F0E68C]/80 text-sm">
              &copy; 2024 avokaGo. Tüm hakları saklıdır.
            </p>
